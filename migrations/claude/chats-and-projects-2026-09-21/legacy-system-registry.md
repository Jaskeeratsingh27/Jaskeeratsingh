...
| Name | Evidence in this archive | Migration treatment |
|---|---|---|
| Kaizen-Orchestrator | Complete project knowledge + long design chat | Migrated now as `kaizen-orchestrator` |
| Hermes Agents Creator | Complete project knowledge + builder chat | Migrated now as `hermes-agent-creator` |
| SecondBrain | Project instructions only; referenced parser/index files absent | Migrated with dependency gate as `secondbrain-curator` |
...
| Vaani | Referenced in agent/FMEA material, source package absent | Await authoritative source |
| Karkhana | Final package repeatedly referenced in chats but ZIP/files absent | Await later archive; do not rebuild from prose |
| Parikshak | Final package repeatedly referenced in chats but ZIP/files absent | Await later archive; do not rebuild from prose |
| Sthapati | Final package repeatedly referenced in chats but ZIP/files absent | Await later archive; do not rebuild from prose |
